...
author: "Jani Helminen, Cédric Briand, Jules Oliviéro, "
fontsize: 20pt
filters:
  - quarto-kroki
  - speakernotes
...
![](images/clipboard-725413065.png){fig-align="left" height="450"}
...
-   Other databases are using this
:::
...
-   Same language for all: DB management and analysis
...
::: {.column width="50%"}
-   We are ready to hand in the simplified version of the metric db. Works for salmon and eel.
...
-   A lot of work has been done with vocab. It will be used for everything. Review needed.
