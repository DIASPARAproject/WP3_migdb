...
![Conceptual schema of the diadromous database](fig-schema_diadromous_db.svg"A schema showing the structure of the database"){#fig-schema_diadromous_db}
...
bind_rows(
  ...
  knitr::kable(caption = "Codes for migratory species in ICES, 
  no code found for other species (Lamprey, Alosa ...)") |>
...
if (file.exists("data/tr_species_spe_temp.Rdata")) {
  load("data/tr_species_spe_temp.Rdata") } else {
    species_list <- tibble(
      ...
      spe_commonname = c("Atlantic salmon", "European eel", "Sea trout", 
      "Twait shad", "Allis shad", "Sea lamprey", "European river lamprey"),
      spe_scientificname = c("Salmo salar", "Anguilla anguilla", 
      "Salmo trutta", "Alosa alosa", "Alosa fallax", "Petromyzon marinus", 
...
knitr::kable(tr_species_spe_temp) |> 
kable_styling(bootstrap_options = c("striped", "hover", "condensed"))
...
dbGetQuery(con_diaspara, "SELECT * FROM dat.t_metadata_met;") |> 
knitr::kable()|>
kable_styling(bootstrap_options = c("striped", "hover", "condensed"))
