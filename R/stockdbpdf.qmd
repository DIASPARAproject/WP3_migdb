...
-   Code are capitalized, e.g working group names
...
When installing diaspara on a server with external connexion, there is a need to edit the pb_hba.conf on the server if not in localhost to allow
access to diaspara.
:::
...
This table has been created here but see the [habitat report](https://diaspara.bordeaux-aquitaine.inrae.fr/deliverables/wp3/p7/stockdb.html) for the full
...
Again, this table has been created in the [habitat report](https://diaspara.bordeaux-aquitaine.inrae.fr/deliverables/wp3/p7/stockdb.html).
...
and the habitat DB proposes a structure of [eel habitat](https://diaspara.bordeaux-aquitaine.inrae.fr/deliverables/wp3/p8/habitatdb.html#creating-a-hierarchical-structure-for-wgeel)

## refeel.tr_version_ver

See [metricDB report](https://diaspara.bordeaux-aquitaine.inrae.fr/deliverables/wp3/p11/metricdb.html#creating-the-version-table-refeel.tr_version_ver)
...
|127186 |	Atlantic salmon |	Salmo salar |	127186|
|126413 |	Twait shad |	Alosa alosa |	126413|
|126415 |	Allis shad |	Alosa fallax |	126415 |	
|101174 |	Sea lamprey |	Petromyzon marinus |	101174|
|101172 |	European river lamprey | Lampetra  fluviatilis |	101172|
|126281 |	European eel |	Anguilla anguilla |	126281|
|127187 |	Sea trout |	Salmo trutta |	127187|
