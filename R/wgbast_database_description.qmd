...
This document does not engage the WGBAST it's just a technical analysis, to take notes and make recommendations.
...
Note the url in this table : 	https://opendata-download.smhi.se/svar/SVAR_Basprodukter_2016_6.pdf is no longer accessed anywhere, there is a NA without value in this table. It does not seems as if there is a hierarchy in these geographic units.
