...
::: notes
Here we only see the main stretch of river since what I'm showing right now is only the hierarchical structure. But within the DB, all tributaries are included. They are linked to the main stretch by an id. Within the RDBES the basin code, which is unique and the name of the river will be included.
:::
...
::: notes
For now data is reported for the whole Baltic Sea but it might change to a finer grain in the future. This will have to be discussed within the WG.
:::
