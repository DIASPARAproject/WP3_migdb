...
t_stock_sto_N = data.frame(
  ...
  sto_are_code = case_when(!is.na(df_all_N$river) ~ df_all_N$riv_are_code,
                           ...
                           df_all_N$sub_div == "23"  ~  "27.3.d.23",
                           df_all_N$sub_div == "22"  ~  "27.3.d.22",
...
system.time(dbWriteTable(con_local, "temp_t_stock_sto_n1", t_stock_sto_N,overwrite = TRUE))
