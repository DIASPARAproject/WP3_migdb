...
The codes are imported in Table @tbl-tr_quality_qal
...
dbExecute(con_diaspara_admin,"DELETE FROM ref.tr_quality_qal WHERE lfs_spe_code ='ANG';")
dbExecute(con_diaspara_admin, "INSERT INTO ref.tr_quality_qal 
SELECT *
FROM refwgeel.tr_lifestage_lfs ;") # 8
