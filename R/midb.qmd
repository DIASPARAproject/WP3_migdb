...
* Foreign key are name `c_fk_columnname` where the column name is the name 
in the table
* Primary keys are names `_pk_columnnames` (with column name having possibly
              ...
              subgraph clusterE {
                ...
                color=black;             
                  subgraph clusterF {
                    ...
                    style=full;
                    color=black;
                    section [label="rivers_section",shape="box", style ="dashed"]                     
                  }
              }
          }
        }
