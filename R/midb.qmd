...
tr_metadata_met <-
    data.frame(
        ...
        met_mtr_code = case_when(metadata$metric == "Standard Variation" ~ "SD",
...
dbExecute(con_diaspara_admin, "INSERT INTO refnas.tr_metadata_met SELECT * from 
tr_metadata_met_temp")
