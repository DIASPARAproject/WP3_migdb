...
data.frame(
ver_code = "NAS_"||2020:2024,
ver_year = 2020:2024
ver_spe_code = "NAS",
ver_datacalldoi=c(NA,NA,NA,"https://doi.org/10.17895/ices.pub.25071005.v3"), 
# TODO FIND other DOI (mail sent to ICES)
ver_version=c(1,1,1,1), # TODO check that there is just one version
ver_description=c(NA,NA,NA,NA))
SELECT 
nas_2020
...
#| message: FALSE
#| code-fold: TRUE
#| code-summary: Code to import to refnas
