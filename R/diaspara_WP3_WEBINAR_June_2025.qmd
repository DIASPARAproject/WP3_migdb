...
Send us email: questions / feedback - we will add it on Github as an issue

# Frame: how are we working

Stock database: picture showing referentials (Cedric will sennd) Data from the different working groups

Example from the metric database example how it will be linked to different database

Finally : we are working on the Vocab of habitat So the other databases are usingi this!
...
-   DIAGRAM
-   CEDRIC WILL SEND A SLDE ABOUT THIS
-   Show also Git timeline
-   Dont worry we will get into this
