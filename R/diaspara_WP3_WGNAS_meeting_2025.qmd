---
title: "Diaspara_WGNAS_meeting_2025"
...
WGEEL, WGBAST and WGNAS have developped their own database. These need to be maintained in the long term.

Use of DATSU (quality insurance and checking procedures for data call)

Use of TAF (Transparent assessment Framework)

Integrating each database in ICES databases would take a lot of ressources.
...
We should be able to provide a common database structure for all species
