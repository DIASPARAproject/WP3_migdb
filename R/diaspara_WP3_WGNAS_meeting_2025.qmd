...
-   EU-Hydro more information but smaller coverage
-   Idea is to have access to both
...
![All Catchments corresponding to ICES ecoregions.](images/fig_final_allcatchments.png "ICES ecoregions and all catchments")
...
![Whole stock level WGBAST](images/WGBAST_hierarchy_whole.png "Baltic Sea as a whole stock unit for Salmon"){#fig-WGBAST_hierarchy_whole}

## Example from WGBAST : Subdivision level

![Subdivision level WGBAST](images/WGBAST_hierarchy_subdivision.png "Baltic Sea Marine and Continental split per subdivision"){#fig-WGBAST_hierarchy_subdivision}
