...
::: {.column width="50%"}
GFCM - RDBFIS
This information could be used in the upcoming RDBFIS database as well
:::
::: {.column width="50%"}
...
-   Development of common dictionaries for things like Age, lifestages, all GIS geopgraphical units
