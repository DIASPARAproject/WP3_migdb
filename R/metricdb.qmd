...
dbGetQuery(con_diaspara, "SELECT * FROM refeel.tr_traitnumeric_trn;")%>% knitr::kable() %>% kable_styling(bootstrap_options = c("striped", "hover", "condensed"))
...
dbGetQuery(con_diaspara, "SELECT * FROM refeel.tr_traitvaluequal_trv;")%>% knitr::kable() %>% kable_styling(bootstrap_options = c("striped", "hover", "condensed"))
...
dbGetQuery(con_diaspara, "SELECT * FROM dateel.t_grouptrait_grt limit 20;")%>% knitr::kable() %>% kable_styling(bootstrap_options = c("striped", "hover", "condensed"))
```
