...
## Creating table dat.t_seriesmetadata_smd


This table holds the metadata at the series level.
A description spans a limited amount of year from
date_begin to date_end. If the series description still hold the date_end is null.

 <details>

<summary>SQL code to create table</summary>

``` {.sql include="../SQL/metric_12_dat.t_seriesmetadata_smd.sql"}
```
...
<summary>SQL code to create inherited table</summary>

``` {.sql include="../SQL/metric_13_dateel.t_seriesmetadata_smd"}
```
