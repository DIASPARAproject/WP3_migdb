...
tranum <- tranum[tranum$tra_code!="Muscle_lipid_gravimeter_perc"] 
tranum$tra_description[tranum$tra_code=="Muscle_lipid_fatmeter_perc"] <-
"Lipid percentage or mean muscle lipid percentage for group"
tranum$tra_code[tranum$tra_code=="Muscle_lipid_fatmeter_perc"] <- "Muscle_lipid"
...
trn_minvalue,
trn_maxvalue
 FROM tr_traitnumeric_trn_temp") #19
...
"trm_description" = c(, "Non invasive estimation of the fat content by measuring the dielectric properties of tissues, this method requires a calibration.","Gravimeter, muscle tissues are dried and the lipids are extracted using solvents, the extracted fat is dried and weighted")
)
