...
```{r ref_tr_traitnumeric_trn_insert}
#| echo: TRUE
#| eval: FALSE
#| warning: FALSE
#| message: FALSE
...
tranum$tra_description[tranum$tra_code=="differentiated_proportion"] <- 'Proportion of differentiated eel'
...
dbExecute(con_diaspara_admin, "DELETE FROM ref.tr_traitnumeric_trn")
...
```{r ref_tr_traitqualitative_trq_insert}
#| echo: TRUE
#| eval: FALSE
#| warning: FALSE
#| message: FALSE
...
dbExecute(con_diaspara_admin, "INSERT INTO ref.tr_traitqualitative_trq(
tra_id,
tra_code,
tra_wkg_code,
tra_spe_code,
