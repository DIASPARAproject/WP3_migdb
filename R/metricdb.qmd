...
        </tr>
  ...
  ann ->  ts [label = "n:1"]
  groupmetrics -> group->  ts [label = "n:1"]
  indmetrics -> fish -> ts [label = "n:1"]
  indmetrics -> trait [label = "n:1"]
  indmetrics -> traitqalvalue [label = "n:1"]
  indmetrics -> traitmethod [label = "n:1"]
  groupmetrics -> trait [label = "n:1"]
  groupmetrics -> traitqalvalue [label = "n:1"]
  groupmetrics -> traitmethod [label = "n:1"]
  groupmetrics -> anneel [label = "implicit (year - ser_id)", style="dashed"]
...
## Values of Qualitative fish trait (tr_traitqualvalue_trv)

The qualitative traits have values

<details>

<summary>SQL code to create table `tr_traitqualvalue_trv` </summary>

``` {.sql include="../SQL/metric_08_ref_tr_traitqualvalue_trv.sql"}
```
</details>
