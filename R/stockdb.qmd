...
The third part is creating referential table for the
...
Finally the fourth part is to import data in the stock database and to 
create a structure working for all the working groups.

The diadromous fish database is in fact made of two main structures.
The first is called ***Stock Database*** and holds values aggregated at the
scale of the assessment unit, or stock unit. The second is the ***Metric Database*** 
...
This habitat used to support both structures has been created using
