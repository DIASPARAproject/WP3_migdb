...
creating a structure working for all the working groups {>>I don't see the difference with part 2: " finding a database structure suiting the needs of all expert 
groups"<<}.
...
This habitat {>>database<<?} used to support both structures has been created using
