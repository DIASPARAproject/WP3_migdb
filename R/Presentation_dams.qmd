...
# To remember: Up- and downstream migration

-   Mortality assessment during the downstream migration requires a lot of details (turbine characteristics, flows, presence of bar racks ...).

-   We can use degraded models using the turbine type only.

-   The most important is where the fish repartition: survivality more dependent on where the fish start than mortality of individual dams.
...
::: r-stack
![](images/clipboard-2093853961.png){.fragment width="576"}
:::
