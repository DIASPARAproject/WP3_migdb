...
COMMENT ON TABLE datbast.t_group_gr IS
...
COMMENT ON COLUMN datbast.t_group_gr.gr_id IS
...
COMMENT ON COLUMN datbast.t_group_gr.gr_wkg_code IS
 'Code of the working group, one of
WGBAST, WGEEL, WGNAS, WKTRUTTA';
COMMENT ON COLUMN datbast.t_group_gr.gr_year IS
 'The year';
COMMENT ON COLUMN datbast.t_group_gr.gr_number IS
 'Number of fish in the group';
COMMENT ON COLUMN datbast.t_group_gr.gr_comment IS
...
COMMENT ON COLUMN datbast.t_group_gr.gr_lastupdate IS
 'Last update, inserted automatically';
COMMENT ON COLUMN datbast.t_group_gr.gr_ver_code IS
