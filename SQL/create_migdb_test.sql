...
CREATE TABLE dat.t_mig_mig (
  ...
  CONSTRAINT c_fk_mig_wkg_code FOREIGN KEY (mig_spe_code) REFERENCES "ref".tr_icworkinggroup_wkg ON UPDATE CASCADE ON DELETE RESTRICT,
  ...
  CONSTRAINT c_fk_mig_mis_code FOREIGN KEY (mig_mis_code) REFERENCES "ref".tr_faoareas(f_division) ON UPDATE CASCADE,
